...
class AuthMiddleware:
    ...
    async def get_current_user(self, token: str = Depends(oauth2_scheme)) -> Dict[str, Any]:
        ...
        if verify_result["status"] != AuthStatus.SUCCESS:
            raise HTTPException(
                ...
                detail=verify_result.get("message", "Invalid or expired token"),
    ...
    async def get_optional_user(self, token: Optional[str] = Depends(oauth2_scheme)) -> Optional[Dict[str, Any]]:
        """
    ...
    async def get_current_user_from_header(self, credentials: HTTPAuthorizationCredentials = Security(security)) -> Dict[str, Any]:
        """
    ...
    def require_permission(self, permission: Permission):
        ...
        Returns:
            Dependency function
        """
        async def permission_dependency(user: Dict[str, Any] = Depends(self.get_current_user)) -> Dict[str, Any]:
            """
    ...
    def require_permissions(self, permissions: List[Permission], require_all: bool = True):
        ...
        Returns:
            Dependency function
        """
        async def permissions_dependency(user: Dict[str, Any] = Depends(self.get_current_user)) -> Dict[str, Any]:
            """
    ...
    def require_role(self, role: str):
        ...
        Returns:
            Dependency function
        """
        async def role_dependency(user: Dict[str, Any] = Depends(self.get_current_user)) -> Dict[str, Any]:
            """
    ...
    def require_roles(self, roles: List[str], require_all: bool = False):
        ...
        Returns:
            Dependency function
        """
        async def roles_dependency(user: Dict[str, Any] = Depends(self.get_current_user)) -> Dict[str, Any]:
            """
