...
def test_mfa():
    ...
    success = response and (response.status_code == 200 or response.status_code == 400)
...
def run_all_tests():
    ...
    print(f"Authentication: {test_results['auth_tests']['passed_count']}/{test_results['auth_tests']['total']} tests passed")
    print(f"RBAC: {test_results['rbac_tests']['passed_count']}/{test_results['rbac_tests']['total']} tests passed")
    print(f"MFA: {test_results['mfa_tests']['passed_count']}/{test_results['mfa_tests']['total']} tests passed")
    print(f"Overall: {passed_tests}/{total_tests} tests passed ({pass_rate:.2f}%)")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="TestSprite Simplified Adapter")
