...
'''
    ...
    try:
        security_result = plugin_system.validate_plugin_security(
            test_plugin_path)
    ...
    success = plugin_system.initialize_plugin_with_monitoring(
        'TestServicePlugin')
    assert success == True
    ...
    dep_result = plugin_system.validate_plugin_dependencies(
        'TestServicePlugin')
    ...
    print(
        f"✅ Plugin System: {len(plugin_system.plugin_instances)} plugins loaded")
    print(
        f"✅ Security: {len(plugin_system.security_validator.restricted_modules)} restrictions enforced")
    print(
        f"✅ Monitoring: {len(plugin_system.plugin_monitor.metrics)} plugin metrics tracked")
    print(
    ...
    system_metrics = plugin_system.get_system_metrics()
    print(
        f"✅ System Status: {system_metrics['total_plugins']} total plugins, {system_metrics['active_plugins']} active")
