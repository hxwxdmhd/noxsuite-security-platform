...
class MCPServerLauncher:
    ...
    def _initialize_default_servers(self):
        ...
        servers = [
            ...
            MCPServerConfig(
                ...
                capabilities=["knowledge_extraction", "conversation_parsing", "semantic_search"],
                env_vars={"MCP_SERVER_MODE": "true", "KNOWLEDGE_BASE_PATH": "mcp/knowledgebase"}
            ),
            MCPServerConfig(
                ...
                capabilities=["code_annotation", "rlvr_injection", "docstring_generation"],
            ...
            MCPServerConfig(
                ...
                capabilities=["dependency_resolution", "auto_installation", "error_recovery"],
    ...
    async def health_check(self, server_name: str) -> bool:
        ...
        try:
            ...
            if process.poll() is not None:
                logger.warning(f"Server {server_name} has crashed (exit code: {process.returncode})")
                ...
                if self.servers[server_name].auto_restart and status.restart_count < 3:
                    logger.info(f"Auto-restarting {server_name} (attempt {status.restart_count + 1})")
    ...
    async def run(self):
        ...
        try:
            ...
            logger.info(f"MCP Server Launcher Status: {summary['servers_running']}/{summary['servers_total']} servers running")
