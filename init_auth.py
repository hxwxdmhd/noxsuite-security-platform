...
def main():
    """Main function"""
    parser = ArgumentParser(description="Initialize NoxSuite users and RBAC settings")
    parser.add_argument("--import-config", type=str, help="Import RBAC configuration from JSON file")
    parser.add_argument("--jwt-secret", type=str, default="your-super-secret-key", help="JWT secret key")
