...
async def list_roles(
    current_user: Dict[str, Any] = Depends(auth_middleware.require_permission(Permission.ADMIN_ACCESS))
):
    """
...
async def create_role(
    ...
    current_user: Dict[str, Any] = Depends(auth_middleware.require_permission(Permission.ADMIN_SETTINGS))
):
    """
    Create a new role
...
async def get_system_metrics(
    current_user: Dict[str, Any] = Depends(auth_middleware.require_permission(Permission.SYSTEM_METRICS))
):
    """
    Get system metrics
...
async def create_system_backup(
    current_user: Dict[str, Any] = Depends(auth_middleware.require_permission(Permission.SYSTEM_BACKUP))
):
    """
...
async def restore_system_backup(
    ...
    current_user: Dict[str, Any] = Depends(auth_middleware.require_permission(Permission.SYSTEM_RESTORE))
):
    """
...
async def get_system_logs(
    ...
    current_user: Dict[str, Any] = Depends(auth_middleware.require_permission(Permission.SYSTEM_LOGS))
):
    """
