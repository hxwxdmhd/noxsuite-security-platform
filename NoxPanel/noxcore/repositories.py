...
class KnowledgeRepository(BaseRepository):
    ...
    def search_knowledge_items(
        self, query: str, category: str = None, limit: int = 50
    ) -> List[Dict[str, Any]]:
    ...
    def get_conversation(
        ...
        try:
            with self.db.get_connection() as conn:
                ...
                conversation["metadata"] = self._deserialize_json(
                ...
                if include_messages:
                    ...
                    for msg_row in cursor.fetchall():
                        ...
                        message["metadata"] = self._deserialize_json(
                            message["metadata"]
                        )
    ...
    def get_session(self, session_id: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            with self.db.get_connection() as conn:
                ...
                if row:
                    session = dict(row)
                    session["session_data"] = self._deserialize_json(
                        session["session_data"]
                    )
                    session["security_flags"] = self._deserialize_json(
...
class AuditRepository(BaseRepository):
            ...
            with self.db.get_connection() as conn:
                ...
                """,
                    (
                        ...
                        resource_type,
                        resource_id,
                        self._serialize_json(details or {}),
                        ip_address,
                        user_agent,
                    ),
                )
    ...
    def get_audit_logs(
        self, user_id: int = None, action: str = None, limit: int = 100
    ) -> List[Dict[str, Any]]:
