...
class LoggingConfig:
    ...
    def _get_default_config(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "format": "enhanced",
            "handlers": {
                "console": {"enabled": True, "level": "INFO", "format": "enhanced"},
                "file": {
                    "enabled": True,
                    "level": "DEBUG",
                    "format": "enhanced",
            ...
            "loggers": {
                ...
                "noxpanel.performance": {"level": "INFO", "handlers": ["file"]},
            },
        }
    ...
    def get_logger(self, name: str) -> logging.Logger:
        ...
        if not any(
            name.startswith(configured_name) for configured_name in self.loggers.keys()
        ):
