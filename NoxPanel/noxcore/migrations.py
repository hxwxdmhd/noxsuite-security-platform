...
class MigrationManager:
    ...
    def migrate_up(self, target_version: Optional[int] = None) -> bool:
        ...
        try:
            ...
            logger.info(
                f"Successfully migrated from version {current_version} to {target_version}"
            )
            return True
    ...
    def migrate_down(self, target_version: int) -> bool:
        ...
        try:
            ...
            logger.info(
                f"Successfully rolled back from version {current_version} to {target_version}"
            )
            return True
...
def main():
    ...
    migrate_parser.add_argument(
        "--version", type=int, help="Target version (default: latest)"
    )
