...
class SQLiteToMariaDBMigrator:
    ...
    def run_migration(self):
        ...
        logger.info(f"Files processed: {self.migration_report['files_processed']}")
        logger.info(f"Tables migrated: {self.migration_report['tables_migrated']}")
        logger.info(f"Rows exported: {self.migration_report['rows_exported']}")
        
        if self.migration_report["errors"]:
            logger.warning(f"Errors encountered: {len(self.migration_report['errors'])}")
